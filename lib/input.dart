    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          Text("Luas layangan",style: TextStyle(fontSize: 40,fontFamily: 'Merienda'),textAlign: TextAlign.center,),
          Container(
          ...
          Text("Keliling layangan",style: TextStyle(fontSize: 40,fontFamily: 'Merienda'),textAlign: TextAlign.center,),
          Container(
            margin: EdgeInsets.only(top:20,left: 100,right: 100),
            height: 50,
            child:  TextField(
