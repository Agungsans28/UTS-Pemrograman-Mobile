  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Profil",style: TextStyle(fontSize: 30,fontFamily: 'Lobster'),),
        centerTitle: true,
      ),
      body: Homeprofile(),
    );
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Box(
                              "1815091058", Icons.book, Colors.black),
                          Box(
                              "Sistem Informasi", Icons.book, Colors.black),
                          Box("Undiksha", Icons.local_post_office,
                              Colors.black),
                          Box("Negara", Icons.directions,
                              Colors.black),
